...
const renderer = jsxRenderer(({ children }) => {
  return /* @__PURE__ */ jsxDEV("html", { children: [
    /* @__PURE__ */ jsxDEV("head", { children: [
      ...
      /* @__PURE__ */ jsxDEV("link", { rel: "stylesheet", href: "/assets/client.css" })
    ] }),
    /* @__PURE__ */ jsxDEV("body", { children: [
      children,
      /* @__PURE__ */ jsxDEV("script", { type: "module", src: "/assets/client.js" })
    ] })
  ] });
});
const app = new Hono();
...
const shell = (c) => c.render(
  /* @__PURE__ */ jsxDEV(Fragment, { children: /* @__PURE__ */ jsxDEV("div", { id: "root" }) })
);
